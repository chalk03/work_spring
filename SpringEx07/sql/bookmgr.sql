...
INSERT INTO book (user_no, title, author, publisher, price, description, attachment)
	VALUES (1, '제목-1', '저자-1', '출판사-1', 10000, '책설명-1', null);

INSERT INTO book (user_no, title, author, publisher, price, description, attachment)
	VALUES (1, '제목-2', '저자-2', '출판사-2', 20000, '책설명-2', null);
	
INSERT INTO book (user_no, title, author, publisher, price, description, attachment)
	VALUES (1, '제목-3', '저자-3', '출판사-3', 10000, '책설명-3', null);
...
SELECT b.isbn, b.user_no, b.title, b.author, b.publisher, b.price, b.attachment, 
