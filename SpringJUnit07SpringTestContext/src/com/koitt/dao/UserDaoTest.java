...
public class UserDaoTest {
	...
	/*
	 * JUnit이 제공하는 애노테이션. 
	 * @Test 메소드가 실행되기 전에 먼저 실행되어야 하는 메소드를 정의
	 */
	@Before
	public void setUp() {
		this.dao = context.getBean("userDao", UserDao.class);
		
		this.user1 = new User("curling", "김영미", "1111");
		this.user2 = new User("speed", "이승훈", "2222");
		this.user3 = new User("skeleton", "윤성빈", "3333");
	 ...
	 * 2. 테스트 클래스의 오브젝트를 하나 만든다. (객체를 매번 새로 만드는 이유는 독립적으로 실행됨을 확실히 보장해주기 위해)
