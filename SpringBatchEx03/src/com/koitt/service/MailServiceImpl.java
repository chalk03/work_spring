	...
	public void sendEmail(Users user) {
		MimeMessagePreparator preparator = new MimeMessagePreparator() {
			...
			public void prepare(MimeMessage mimeMessage) throws Exception {
				...
				helper.setFrom("ccumi03@gmail.com");		// 보내는사람 이메일 주소
				helper.setTo("chalk03@naver.com");			// 받는사람 이메일 주소
				helper.setSubject("[KOITT] 이메일 인증코드");	// 메일 제목
				helper.setText(text, true);					// 메일 내용, true는 HTML mail
				
				// 받는사람 이메일 값과 메일 내용 테스트위해 콘솔에 출력
				System.out.println("chalk03@naver.com");
				...
				// 첨부파일
				helper.addAttachment("document.csv", new FileSystemResource("C:/test/prac03/board.csv"));
			}
		};
